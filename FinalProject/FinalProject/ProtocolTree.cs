...
namespace FinalProject
{
    class ProtocolTree : Tree
    {
        ...
        public static ProtocolTree kw_trans(FormulaTree f_tree)
        {
            ...
            PartyNode p_root = new PartyNode(root_name, root_type, root_depth, p_num_of_children, null,f_root);
            ...
            while (s.Count > 0) 
            {
                ...
                // Do Action
                PartyNode p_tmp_node = new PartyNode(n);
        ...
        public static ProtocolTree egh(ProtocolTree kw_tree)
        {
            ...
            foreach (Node node in kw_tree)
            {
                ...
                if (node.get_child(num_of_children_idx) == null)
                {
                    ...
                    ProtocolTree cloned_sub_tree = (ProtocolTree)sub_tree.deep_copy();
                }
            }
