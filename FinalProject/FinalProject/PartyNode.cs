...
namespace FinalProject
{
    class PartyNode : Node
    {
        ...
        public PartyNode(Node node) : base(node)
        {
            ...
            Array.Resize(ref m_children, m_number_of_children);
            m_children[m_number_of_children - 1] = null;
